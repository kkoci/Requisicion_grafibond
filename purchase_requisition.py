...
class purchase_requisition(osv.osv):
    ...
    _columns = {
		...
		'prioridad' : fields.selection([('alta','Alta'),('normal','Normal'),('baja', 'Baja')], 'Prioridad'),
		...
		'requisicion_interna' : fields.integer('Requisicion Interna'),
		'proveedor_sugerido' : fields.many2one('res.partner', 'Proveedor Sugerido'),
		'requisicion_importacion' : fields.integer('Requisicion de Importacion'),
